...
?>
	<div class="row <?php if ($count > 1) { echo('oddcolor'); $count=0; } else { echo('evencolor'); } ?>">
		...
		<div class="col2"><a href="<?php echo $row_rsProductsCategory['product_file']; ?>"><img src="<?php echo $row_rsProductsCategory['product_file']; ?>" width="50"></a></div>
		<div class="col2"><?php echo $row_rsProductsCategory['category_name']; ?></div>
		<div class="col1"><?php echo $var_status; ?></div>
		<div class="col1"><a href="product-edit.php?recordID=<?php echo $row_rsProductsCategory['product_id']; ?>">Edit</a> | <a href="product-delete.php?recordID=<?php echo $row_rsProductsCategory['product_id']; ?>">Delete</a></div>
	</div>
	<hr/>
	<?php $count++; ?>
