    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Plantilla Nueva</a>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="container" style="margin-bottom: 30px;">
                <form method="GET" action="index.php">
                    <input type="text" id="product_name" name="product_name" placeholder="Nombre del producto" value=""/>
        ...
        <div class="row">
            ...
            //Conectarse a la base de datos
                ...
                $strsql = "SELECT p.product_id, p.product_name, c.category_name, p.product_seo, p.product_price FROM products p, categories c WHERE p.product_category_id = c.category_id AND p.product_name LIKE '%$product_name%' AND p.product_status = '$product_status' ORDER BY p.product_price DESC";
            ...
            <?php do { ?>
               <div class="col-md-4 portfolio-item" id="id<?php echo($row['product_id']);?>">
                    <a href="#">
